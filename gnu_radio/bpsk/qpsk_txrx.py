...
class qpsk_txrx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.variable_qtgui_range_delay = variable_qtgui_range_delay = 45
        self.variable_qtgui_range_0_0 = variable_qtgui_range_0_0 = 1.603
        self.variable_qtgui_range_0 = variable_qtgui_range_0 = 3.589
        self.variable_constellation_0 = variable_constellation_0 = digital.constellation_calcdist([-1-1j, 1+1j], [0, 1],
        ...
        # Blocks
        ##################################################
        self._variable_qtgui_range_0_0_range = Range(0, 2, 0.001, 1.603, 200)
        self._variable_qtgui_range_0_0_win = RangeWidget(self._variable_qtgui_range_0_0_range, self.set_variable_qtgui_range_0_0, "Amplitude Shift", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._variable_qtgui_range_0_0_win)
        self._variable_qtgui_range_delay_range = Range(0, 128, 1, 45, 16)
        self._variable_qtgui_range_delay_win = RangeWidget(self._variable_qtgui_range_delay_range, self.set_variable_qtgui_range_delay, "Time Delay", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._variable_qtgui_range_delay_win)
        self._variable_qtgui_range_0_range = Range(0, 2*3.14, 0.001, 3.589, 200)
        self._variable_qtgui_range_0_win = RangeWidget(self._variable_qtgui_range_0_range, self.set_variable_qtgui_range_0, "Phase Shift", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(variable_qtgui_range_0_0)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/oshears/Documents/bladeRF/bladerf_dfr_accelerator/gnu_radio/qpsk/tx_data.bin', True, 0, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.digital_symbol_sync_xx_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.blocks_file_sink_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.digital_constellation_decoder_cb_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.qtgui_const_sink_x_0, 1))
        ...
        self.connect((self.soapy_bladerf_source_0, 0), (self.digital_costas_loop_cc_0, 0))
    ...
    def get_variable_qtgui_range_delay(self):
        return self.variable_qtgui_range_delay

    def set_variable_qtgui_range_delay(self, variable_qtgui_range_delay):
        self.variable_qtgui_range_delay = variable_qtgui_range_delay
    ...
    def set_variable_qtgui_range_0_0(self, variable_qtgui_range_0_0):
        ...
        self.blocks_multiply_const_vxx_1.set_k(self.variable_qtgui_range_0_0)
