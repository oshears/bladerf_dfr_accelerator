...
class wbfm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "wbfm_receiver")
        ...
        self.connect((self.soapy_bladerf_source_0, 0), (self.analog_wfm_rcv_0, 0))
...
def main(top_block_cls=wbfm_receiver, options=None):
