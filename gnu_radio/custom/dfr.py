...
class dfr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_throttle_0, 0), (self.digital_constellation_encoder_bc_1, 0))
        self.connect((self.digital_constellation_encoder_bc_1, 0), (self.epy_block_0, 0))
